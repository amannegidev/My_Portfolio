  ...
  return (
    <section className="pt-6 lg:py-20">
      <div className="container mx-auto px-4 text-start md:text-center ">
        <div className="contact-box rounded-lg bg-black py-12 pr-6 pl-2 text-white ">
          <h2 className="text-xl lg:text-5xl  mb-6 text-white leading-relaxed">
            {title}
          </h2>
          <p className="text-sm md:text-lg mb-8 mx-auto pr-4 md:pd-r-1 display-none md-display-block">
            {description}
          </p>
          <Link 
            href={buttonLink} 
